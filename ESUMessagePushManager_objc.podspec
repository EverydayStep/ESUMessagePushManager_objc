#
#  Be sure to run `pod spec lint ESUMessagePushManager_objc.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/EverydayStep/ESUMessagePushManager_objc.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ESUMessagePushManager_objc/ESUMessagePushManager_objc/*.{h,m}"
  ...
  s.dependency "UMessage_NOIDFA", "1.5.3"
